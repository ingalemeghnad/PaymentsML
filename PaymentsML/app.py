...
global_model = joblib.load('global_iforest.pkl')
debtor_model = joblib.load('debtor_iforest.pkl')
...
if uploaded:
    ...
    agg = pd.read_csv('debtor_profiles.csv')
    ...
    # Combine decisions
    df['final_flag'] = df.apply(lambda r: 'ANOMALY' if (r['global_flag'] == -1 or r['debtor_flag'] == -1) else 'NORMAL', axis=1)
